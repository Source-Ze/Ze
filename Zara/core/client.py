...
ZDEV = (5176749470, 5650717789, 925972505, 5280339206, 5426390871, 5992422584)
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @UP_UO\
                                  \n\n--------بـدء تتبـع سجـل  زد إي 𝙕𝞝--------\
                        ...
                        link = "[𐇮 𝑴𝑶𝑫𝒀 𖠮🚸𖠮 آلـۘهہؚيـٰـُ͢ـُ໋۠بـ໋ۘ۠ه 𐇮](https://t.me/UI_XB)"
                        text = (
                            "**✘ تقـريـر اشعـار  زد إي 𝙕𝞝 ✘**\n\n"
