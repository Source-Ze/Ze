...
async def variable(var):  # sourcery no-metrics
    ...
    if exe == "get":
        ...
        if variable in heroku_var:
            await zed.edit("**⌔∮ تم تغيـر** `{}` **:**\n **- المتغير :** `{}` \n**- يتم الان اعـادة تشغيـل بـوت  زد إي يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(variable, value))
        else:
        ...
        await zed.edit(f"**⌔∮** `{variable}`  **تم حذفه بنجاح. \n**يتم الان اعـادة تشغيـل بـوت  زد إي يستغـرق الامر 2-1 دقيقـه ▬▭ ...**")
