...
# بلاي 
M = (
    "**𓆰**  𝙎𝙊𝙐𝙍𝘾𝙀 𝙕𝞝   **العـاب الاونلايـن** 🎮𓆪 \n"
    "◐━─━─━─━─𝙕𝞝─━─━─━─━◐\n\n"
    ...
    "**𓄂-** 𝙎𝙊𝙐𝙍𝘾𝙀 𝘿𝙀𝙑 **⪼**  [𐇮 𝑴𝑶𝑫𝒀 𖠮🚸𖠮 آلـۘهہؚيـٰـُ͢ـُ໋۠بـ໋ۘ۠ه 𐇮(t.me/UP_UO)   \n"
    "**𓆰** 𝙎𝙊𝙐𝙍𝘾𝙀 𝙍𝙀𝙋𝙊 **⪼**  [𝙕𝞝](https://t.me/UI_XB)  "
)
...
@zedub.zed_cmd(
    ...
    info={
        "header": "العـاب الانـلاين لـ سـورس زد إي",
        "الاستـخـدام": "{tr}بلاي",
    },
)
